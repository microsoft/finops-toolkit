...
The same file holds the demo data source (`demo.storageUrl`, `demo.clusterUrl`) that demo projects are stamped with. Update it when the demo hub changes. Templates always ship with the data source set to null.
