...
ms.service: finops
ms.reviewer: hepint
#customer intent: As a FinOps user, I want to understand how to configure Log Analytics for Azure optimization engine (AOE).
---

<!-- markdownlint-disable-next-line MD025 -->
# Configuring workspaces for Azure optimization engine
...
:::image type="content" source="../../media/aoe/loganalytics-additionalperfworkspaces.jpg" border="true" alt-text="Adding an Automation Account variable with a list of additional workspace IDs for the VM right-size recommendations" lightbox="../../media/aoe/loganalytics-additionalperfworkspaces.jpg":::
