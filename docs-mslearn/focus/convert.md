...
| BillingAccountType         | Enterprise Agreement: `Billing Account`<br><br>Microsoft Customer Agreement: `Billing Profile`     | New in FOCUS 1.2.                                                                                                                                                                                                                                                                         |
...
| ServiceSubcategory         | ServiceSubcategory (lookup)                                                                        | Map ConsumedService and ResourceType to ServiceSubcategory using [Services data file](../toolkit/open-data.md#services). New in FOCUS 1.1.                                                                                                                                               |
