...
| BillingAccountName           | (All)                      | Enterprise Agreement: Use **BillingAccountName**<br><br>Microsoft Customer Agreement: Use **x_BillingAccountName**.                                                 |
...
| PricingCurrency              | (All)                      | Use **PricingCurrency**.                                                                                                                                            |
