...
description: Learn how to install and customize the Cost Optimization Workbook to access tools and insights for improving resource utilization and efficiency.
author: bandersmsft
ms.author: banders
ms.date: 11/05/2024
ms.topic: how-to
...
#customer intent: As a FinOps user, I want to understand theCost optimization workbook so that I can use it.
---
