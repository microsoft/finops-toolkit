...
| **enableRecommendations**              | Bool   | Optional. Enable ARG-based recommendations ingestion. Queries Azure Resource Graph daily for cost optimization recommendations including Azure Advisor and custom queries. Requires Azure Data Explorer or Microsoft Fabric. The Data Factory managed identity requires Reader role on management groups or subscriptions to execute Resource Graph queries.                                                                                                                                                | True               |
