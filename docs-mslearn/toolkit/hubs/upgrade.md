...
- **ContractCommitments** includes 28 FOCUS columns: `BenefitCategory`, `BillingCurrency`, `ContractCommitmentApplicability`, `ContractCommitmentCategory`, `ContractCommitmentCost`, `ContractCommitmentId`, `ContractCommitmentPeriodEnd`, `ContractCommitmentPeriodStart`, `ContractCommitmentQuantity`, `ContractCommitmentType`, `ContractCommitmentUnit`, `ContractId`, `ContractPeriodEnd`, `ContractPeriodStart`, `Created`, `DiscountPercentage`, `DurationType`, `FulfillmentInterval`, `InvoiceIssuerName`, `LastUpdated`, `LifecycleStatus`, `Model`, `OfferCategory`, `PaymentInterval`, `PaymentModel`, `PaymentUpfrontPercentage`, `PricingCurrency`, and `PricingCurrencyContractCommitmentCost`.
