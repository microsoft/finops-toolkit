...
- **Changed**
  ...
  - Updated the hub cost estimate consistently across the overview note, the Power BI data source comparison table, and the portal deploy UI to reflect real-world Azure Data Explorer and Microsoft Fabric pricing, and called out that Data Explorer cost varies significantly by region; the previous flat estimate understated actual cost for some regions and SKUs ([#2229](https://github.com/microsoft/finops-toolkit/issues/2229)).
- **Fixed**
