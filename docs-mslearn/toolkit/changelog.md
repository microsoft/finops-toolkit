...
- **Added**
  ...
  - Added [sovereign cloud deployment guide](hubs/deploy-sovereign.md) with build, deployment, and configuration steps.
- **Fixed**
  - Fixed hardcoded Kusto DNS suffix to use an environment-aware lookup map with correct suffixes for all supported clouds ([#2072](https://github.com/microsoft/finops-toolkit/pull/2072)).
  ...
  - Fixed hardcoded `portal.azure.com` URLs in `dashboard.json` to use build-time parameterization.
  - Fixed `gitapp.hub.com` typo in ADF linked service URL.
