...
- **Fixed**
  ...
  - Fixed ADF triggers not starting after deployment by removing the `startAllTriggers` parameter and making Init-DataFactory.ps1 handle both string and boolean environment variable values ([#1877](https://github.com/microsoft/finops-toolkit/issues/1877)).
