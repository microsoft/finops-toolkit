...
- **Fixed**
  - Clarified private hub networking ownership and supported private-access models, and added a diagram for the preferred customer-managed private endpoint model ([#2156](https://github.com/microsoft/finops-toolkit/issues/2156)).
