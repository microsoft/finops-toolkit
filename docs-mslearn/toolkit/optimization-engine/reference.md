...
This article provides reference information for the Azure Optimization Engine, including runbooks, schedules, variables, and tables. The runbooks form a data pipeline that collects, ingests, and analyzes Azure data into Log Analytics and SQL Database tables to generate recommendations for optimization.
