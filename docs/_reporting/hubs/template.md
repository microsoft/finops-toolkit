...
1. You must have the following permissions to create the [deployed resources](#️-resources).
   ...
   | Create a cost export<sup>2</sup>                                | [Cost Management Contributor](https://learn.microsoft.com/azure/role-based-access-control/built-in-roles#cost-management-contributor)                                  |
