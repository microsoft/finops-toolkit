...
<div id="whats-new" class="ftk-new">
    ...
    <p>
        In August, FinOps hubs added VNet and private network modes with optional NAT Gateway support, a guide to run FinOps hubs using a local Kusto emulator, and fixed several KQL join and cost recompute issues.
    </p>
