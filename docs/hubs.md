...
<div id="whats-new" class="ftk-new">
    ...
    <p>
        In September, FinOps hubs added VNet and private network modes with optional NAT Gateway support, a guide to run FinOps hubs using a local Kusto emulator, and fixed several KQL join, managed export permission, and cost recompute issues.
    </p>
