...
<div id="whats-new" class="ftk-new">
    ...
    <p>
        In September, FinOps alerts made join kinds explicit in the idle application gateway and idle public IP queries so they no longer rely on the default join behavior.
    </p>
