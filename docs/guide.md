...
<div id="whats-new" class="ftk-new">
    ...
    <p>
        In September, the Implementing FinOps guide added a FinOps toolkit ecosystem page and aligned capability names and links to current FinOps Framework terminology.
    </p>
