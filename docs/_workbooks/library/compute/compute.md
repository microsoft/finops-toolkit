...
1. [Virtual Machines](#virtual-machines)
   - [Query: Virtual Machines Not Deallocated or Running](#query-virtual-machines-not-deallocated-or-running)
2. [Virtual Machine Scale Sets Analysis](#query-virtual-machine-scale-sets-analysis)
3. [Azure App Service](#azure-app-service)
   - [Query: Web Function Status](#query-web-function-status)
   - [Query: App Service Plan Details](#query-app-service-plan-details)
4. [Query: AKS Cluster](#query-aks-cluster)
