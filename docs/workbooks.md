...
<div id="whats-new" class="ftk-new">
    ...
    <p>
        In September, FinOps workbooks fixed savings plan and Azure Hybrid Benefit queries that were silently dropping or missing recommendations due to implicit join behavior.
    </p>
