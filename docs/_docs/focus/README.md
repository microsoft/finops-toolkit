...
If you have feedback about our mappings or about our full FOCUS support plans, please start a thread in [discussions](https://github.com/microsoft/finops-toolkit/discussions). If you believe you've found a bug, please [create an issue](https://aka.ms/ftk/idea).
