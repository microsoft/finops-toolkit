...
has_children: true
nav_order: 1
description: 'PowerShell commands for general FinOps toolkit operations.'
permalink: /powershell/toolkit
---

<span class="fs-9 d-block mb-4">FinOps toolkit automation</span>
Get details about FinOps toolkit releases.
{: .fs-6 .fw-300 }
