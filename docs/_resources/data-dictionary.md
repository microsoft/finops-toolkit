...
| <a name="d"></a>DiscountCostSavings<sup>⚠️</sup>   | Derived. Total amount saved after negotiated and commitment discounts are applied. Will be negative for unused commitments. Formula: `ListCost - EffectiveCost`.                                                                                                       |
