...
export function createDashboardCanvas(dependencies = {}) {
  ...
  return canvasFactory({
    ...
    description: "Live FinOps dashboard for local and remote hubs with cost, allocation, rate, usage, anomaly, AI tokenomics, AI and emerging workload, and capacity evidence views.",
    inputSchema: {
      type: "object",
      additionalProperties: false,
      properties: {
