...
The Capacity workspace shows seven evidence classes: App Service, Azure AI, Compute, Azure SQL, Storage, capacity reservations, and Premium SSD v2.

The workspace doesn't combine unlike evidence into one score. It keeps these concepts separate:
...
Only registered Compute metrics support quota utilization and headroom calculations. Unknown metrics remain visible as descriptive evidence. Stale or invalid rows don't receive quota-health calculations.
