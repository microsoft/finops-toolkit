// Description: The transform pipeline for cost management data.
//              The pipeline converts the CSV files to Parquet .CSV.GZ files.
//              The pipeline is triggered by the extract pipeline.
