...
$reports | ForEach-Object {
    ...
    $metadata = @{
        ...
        Governance           = @{
            Intro       = "The Governance, Policy & Risk report summarizes your Microsoft Cloud governance posture. It offers the standard metrics aligned with the Cloud Adoption Framework to facilitate identifying issues, applying recommendations, and resolving compliance gaps."
        ...
        RateOptimization     = @{
            Intro       = "The Rate optimization report provides insights into rate optimization opportunities, like reservations, savings plans, and Azure Hybrid Benefit. This reports uses effective cost, which amortizes and breaks reservation and savings plan purchases down and allocates costs out to the resources that received the benefit. Effective cost will not match your invoice."
