...
| 9 | [x] | ~~MED~~ | Nonexistent scripts referenced in `azure-savings-plans.md` | flanakin | **Fixed.** Added `Get-BenefitRecommendations.ps1` to `skills/azure-cost-management/references/`. |
