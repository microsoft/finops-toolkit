...
@description('Optional. Name of the subnet used for deployment scripts. Used when private routing is enabled. Default: "script-subnet".')
param scriptSubnetName string = 'script-subnet'
