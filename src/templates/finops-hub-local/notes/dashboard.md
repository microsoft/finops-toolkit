...
> browsers (**Microsoft Edge, Google Chrome**) do *not* apply mixed-content blocking to it.
...
where you previously clicked *Block*), relax the check for local UAT by launching the browser
