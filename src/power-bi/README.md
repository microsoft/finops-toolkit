...
8. The data source saved in the semantic model is the demo hub, which is what demo reports connect to. Update it when the demo hub changes. Templates always ship with it set to null.
