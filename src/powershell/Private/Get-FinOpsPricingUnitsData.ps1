...
function Get-FinOpsPricingUnitsData {
    return [PSCustomObject]@(
        ...
        ,[PSCustomObject]@{ UnitOfMeasure = '1 Count'; AccountTypes = 'MCA'; PricingBlockSize = 1; DistinctUnits = 'Count'; }
        ...
        ,[PSCustomObject]@{ UnitOfMeasure = '1 GB/Day'; AccountTypes = 'MCA'; PricingBlockSize = 1; DistinctUnits = 'GB/Day'; }
        ...
        ,[PSCustomObject]@{ UnitOfMeasure = '1 GB/月'; AccountTypes = 'MCA'; PricingBlockSize = 1; DistinctUnits = 'GB/Month'; }
        ,[PSCustomObject]@{ UnitOfMeasure = '1 Gb'; AccountTypes = 'MCA'; PricingBlockSize = 1; DistinctUnits = 'GB'; }
        ,[PSCustomObject]@{ UnitOfMeasure = '1 GiB'; AccountTypes = 'MCA'; PricingBlockSize = 1; DistinctUnits = 'GiB'; }
        ...
        ,[PSCustomObject]@{ UnitOfMeasure = '1 IOPS/Month'; AccountTypes = 'MCA'; PricingBlockSize = 1; DistinctUnits = 'IOPS/Month'; }
        ...
        ,[PSCustomObject]@{ UnitOfMeasure = '1 Rotation'; AccountTypes = 'MCA'; PricingBlockSize = 1; DistinctUnits = 'Rotation'; }
        ,[PSCustomObject]@{ UnitOfMeasure = '1 Second'; AccountTypes = 'MCA'; PricingBlockSize = 1; DistinctUnits = 'Seconds'; }
        ...
        ,[PSCustomObject]@{ UnitOfMeasure = '1 小时'; AccountTypes = 'MCA'; PricingBlockSize = 1; DistinctUnits = 'Hours'; }
        ...
        ,[PSCustomObject]@{ UnitOfMeasure = '1/小时'; AccountTypes = 'MCA'; PricingBlockSize = 1; DistinctUnits = 'Units/Hour'; }
        ...
        ,[PSCustomObject]@{ UnitOfMeasure = '10M'; AccountTypes = 'MCA'; PricingBlockSize = 10000000; DistinctUnits = 'Units'; }
        ...
        ,[PSCustomObject]@{ UnitOfMeasure = '1K'; AccountTypes = 'MCA'; PricingBlockSize = 1000; DistinctUnits = 'Units'; }
